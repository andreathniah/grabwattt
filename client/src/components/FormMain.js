...
class FormMain extends React.Component {
	...
	componentDidMount() {
		const alertMsg =
			"I am aware that increasing numbers of 'something went wrong' errors are being generated by Grabwatt. This is due to large number of concurrent requests and a lack of funds to upgrade Grabwatt's server. I am working on a fix towards that, do be patient and consider donating!";
